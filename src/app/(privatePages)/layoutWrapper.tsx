      ...
      <div className="font-dm flex-1">
        <main className="h-full w-full">
          <div className='flex gap-2 h-full'>
            <Sidebar routes={isNestedRoute(pathname) ? subRoutes : routes} open={open} setOpen={setOpen} variant="admin" />
...
const MainNavBar = () => {
  ...
  return (
    <>
      ...
      <Button onPress={onOpen} color='primary' startContent={<AiOutlinePlus color='white' />}>Create {pathname.includes("projects") ? "Project" : "Dashboard"}</Button>
      <Modal
        isOpen={isOpen}
            ...
            <>
              ...
              <ModalBody>
                <InputField
                  ...
                  className="bg-white border-[#F4F4F4]"
                  onChange={() => {
                    console.log(123);
                  }} />
...
const SubNavBar = () => {
  ...
  return (
    <>
      ...
      <Button onPress={onOpen} className="bg-white border" >Invite</Button>
    </>
  )
}